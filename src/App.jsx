...
const createDefaultNoiseSettings = () => ({
  ...
  noise_router: {
    barrier: { type: 'minecraft:noise', noise: 'minecraft:aquifer_barrier', xz_scale: 1, y_scale: 0.5 },
    fluid_level_floodedness: { type: 'minecraft:noise', noise: 'minecraft:aquifer_fluid_level_floodedness', xz_scale: 1, y_scale: 0.67 },
    fluid_level_spread: { type: 'minecraft:noise', noise: 'minecraft:aquifer_fluid_level_spread', xz_scale: 1, y_scale: 0.7142857142857143 },
    lava: { type: 'minecraft:noise', noise: 'minecraft:aquifer_lava', xz_scale: 1, y_scale: 1 },
    temperature: { type: 'minecraft:shifted_noise', noise: 'minecraft:temperature', xz_scale: 0.25, y_scale: 0, shift_x: 'minecraft:shift_x', shift_y: 0, shift_z: 'minecraft:shift_z' },
    vegetation: { type: 'minecraft:shifted_noise', noise: 'minecraft:vegetation', xz_scale: 0.25, y_scale: 0, shift_x: 'minecraft:shift_x', shift_y: 0, shift_z: 'minecraft:shift_z' },
    continents: { type: 'minecraft:flat_cache', argument: { type: 'minecraft:shifted_noise', noise: 'minecraft:continentalness', xz_scale: 0.25, y_scale: 0, shift_x: 'minecraft:shift_x', shift_y: 0, shift_z: 'minecraft:shift_z' } },
    erosion: { type: 'minecraft:flat_cache', argument: { type: 'minecraft:shifted_noise', noise: 'minecraft:erosion', xz_scale: 0.25, y_scale: 0, shift_x: 'minecraft:shift_x', shift_y: 0, shift_z: 'minecraft:shift_z' } },
    depth: { type: 'minecraft:add', argument1: { type: 'minecraft:y_clamped_gradient', from_y: -64, to_y: 320, from_value: 1.5, to_value: -1.5 }, argument2: 0 },
    ridges: { type: 'minecraft:flat_cache', argument: { type: 'minecraft:shifted_noise', noise: 'minecraft:ridge', xz_scale: 0.25, y_scale: 0, shift_x: 'minecraft:shift_x', shift_y: 0, shift_z: 'minecraft:shift_z' } },
    initial_density_without_jaggedness: { type: 'minecraft:mul', argument1: 4, argument2: { type: 'minecraft:quarter_negative', argument: { type: 'minecraft:mul', argument1: { type: 'minecraft:add', argument1: { type: 'minecraft:y_clamped_gradient', from_y: -64, to_y: 320, from_value: 1.5, to_value: -1.5 }, argument2: 0 }, argument2: { type: 'minecraft:add', argument1: { type: 'minecraft:y_clamped_gradient', from_y: -64, to_y: 320, from_value: 1, to_value: -1 }, argument2: { type: 'minecraft:constant', argument: 0.5 } } } } },
    final_density: { type: 'minecraft:min', argument1: { type: 'minecraft:squeeze', argument: { type: 'minecraft:mul', argument1: 0.64, argument2: { type: 'minecraft:interpolated', argument: { type: 'minecraft:blend_density', argument: { type: 'minecraft:mul', argument1: 4, argument2: { type: 'minecraft:quarter_negative', argument: { type: 'minecraft:mul', argument1: { type: 'minecraft:add', argument1: { type: 'minecraft:y_clamped_gradient', from_y: -64, to_y: 320, from_value: 1.5, to_value: -1.5 }, argument2: 0 }, argument2: { type: 'minecraft:add', argument1: { type: 'minecraft:y_clamped_gradient', from_y: -64, to_y: 320, from_value: 1, to_value: -1 }, argument2: { type: 'minecraft:constant', argument: 0.5 } } } } } } } } }, argument2: { type: 'minecraft:noise', noise: 'minecraft:aquifer_barrier', xz_scale: 1, y_scale: 0.5 } },
    vein_toggle: { type: 'minecraft:interpolated', argument: { type: 'minecraft:range_choice', input: { type: 'minecraft:y_clamped_gradient', from_y: -64, to_y: 320, from_value: 1, to_value: -1 }, min_inclusive: -0.2, max_exclusive: 0.2, when_in_range: { type: 'minecraft:noise', noise: 'minecraft:ore_veininess', xz_scale: 1.5, y_scale: 1.5 }, when_out_of_range: 0 } },
    vein_ridged: { type: 'minecraft:add', argument1: -0.07999999821186066, argument2: { type: 'minecraft:max', argument1: { type: 'minecraft:abs', argument: { type: 'minecraft:interpolated', argument: { type: 'minecraft:noise', noise: 'minecraft:ore_vein_a', xz_scale: 4, y_scale: 4 } } }, argument2: { type: 'minecraft:abs', argument: { type: 'minecraft:interpolated', argument: { type: 'minecraft:noise', noise: 'minecraft:ore_vein_b', xz_scale: 4, y_scale: 4 } } } } },
    vein_gap: { type: 'minecraft:noise', noise: 'minecraft:ore_gap', xz_scale: 1, y_scale: 1 }
  },
  spawn_target: [],
  surface_rule: {
    type: 'minecraft:sequence',
    sequence: [
      { type: 'minecraft:condition', if_true: { type: 'minecraft:vertical_gradient', random_name: 'minecraft:bedrock_floor', true_at_and_below: { absolute: -64 }, false_at_and_above: { above_bottom: 5 } }, then_run: { type: 'minecraft:block', result_state: { Name: 'minecraft:bedrock' } } },
      { type: 'minecraft:condition', if_true: { type: 'minecraft:stone_depth', offset: 0, surface_type: 'floor', add_surface_depth: false, secondary_depth_range: 0 }, then_run: { type: 'minecraft:sequence', sequence: [ { type: 'minecraft:condition', if_true: { type: 'minecraft:water', offset: -1, surface_depth_multiplier: 0, add_stone_depth: false }, then_run: { type: 'minecraft:block', result_state: { Name: 'minecraft:grass_block', Properties: { snowy: 'false' } } } }, { type: 'minecraft:block', result_state: { Name: 'minecraft:dirt' } } ] } },
      { type: 'minecraft:condition', if_true: { type: 'minecraft:stone_depth', offset: 0, surface_type: 'floor', add_surface_depth: true, secondary_depth_range: 0 }, then_run: { type: 'minecraft:block', result_state: { Name: 'minecraft:dirt' } } }
    ]
  }
});
