 ...
 * Source: vanilla_data/data/minecraft/worldgen
 */

export const WORLDGEN_REGISTRIES = {
  biome: [
    'minecraft:badlands',
  ...
  configured_feature: [
    ...
    'minecraft:patch_dry_grass',
    'minecraft:patch_fire',
    'minecraft:patch_firefly_bush',
...
export const WORLDGEN_TYPES = Object.keys(WORLDGEN_REGISTRIES);
